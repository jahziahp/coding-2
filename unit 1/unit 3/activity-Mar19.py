...
'Python OOP - object oreinted programing and object oreinted programing of some complex data structure '

# 2. In your own words, what is a object property and and object method? Please
# write your response as a string data type.
'object property is a key vaule pair for such a traits. and obejct method is Methods are actions that can be performed on objects'
...
class VirgilOutLine:
    def _init_(self, name, age, hair, skincolor, eyecolor):
        self.name = name
        self.age = age
        self.hair = hair
